...
- This error can be detected by _"wildcard"_ **Error Handler MiddleWare**.
...
- For collections with a **high write-to-read ratio**, _indexes are expensive because each insert must also update any indexes_.
